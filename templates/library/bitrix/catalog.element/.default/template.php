...
$arFirstPhoto = $arResult['DETAIL_PICTURE'];
if(empty($arFirstPhoto)) $arFirstPhoto = $arResult['PREVIEW_PICTURE'];
		...
		<?if(empty($arResult['PREVIEW_PICTURE']['SRC'])):?>
								<div class = 'no_image_cover'>
									<div class = 'no_image_cover_author'>
										<?if(is_array($arResult['DISPLAY_PROPERTIES']['AUTHOR']['DISPLAY_VALUE'])) echo strip_tags(implode(", ",$arResult['DISPLAY_PROPERTIES']['AUTHOR']['DISPLAY_VALUE'])); else echo strip_tags($arResult['DISPLAY_PROPERTIES']['AUTHOR']['DISPLAY_VALUE'])?>
									</div>
									<div class = 'no_image_cover_title'>
										<?=$arResult['NAME']?>
									</div>
									<div class = 'no_image_cover_year'>
										<?=$arResult['DISPLAY_PROPERTIES']['YEAR_PUBLICATION']['DISPLAY_VALUE']?>
									</div>
								</div>
						<?else:?>
							
		<img id="<? echo $arItemIDs['PICT']; ?>" src="<? echo $arFirstPhoto['SRC']; ?>" alt="<? echo $strAlt; ?>" title="<? echo $strTitle; ?>"></span>
	<?endif?>
<?
...
if($arResult['PROPERTIES']['FILE_SOURCE']['VALUE']!= '')
			$file_src = $arResult['PROPERTIES']['FILE_SOURCE']['VALUE'];
		elseif($arResult['PROPERTIES']['FILE_VIEW']['VALUE']!= '')
			$file_src = $arResult['PROPERTIES']['FILE_VIEW']['VALUE']; 
...
<div class="button_wrap">
	<?if($dounload_url = CFile::GetPath($file_src)):?>
		<a class="bx-disk-context-button" title="Скачать" href = "<?=$dounload_url?>" target = "blank">
			<span class="bx-disk-context-button-icon element-upload" ></span>
			<span class="bx-disk-context-button-text">Скачать</span>
		</a>
	<?endif?>
	<?if($wopi_url = CWopiFile::GetPath($file_src)): ?>
	<a class="bx-disk-context-button" title="Открыть в Web Apps" href = "<?=$wopi_url;?>" target = "blank">
		<span class="bx-disk-context-button-icon folder-add"></span>
		<span class="bx-disk-context-button-text">Открыть в Web Apps</span>
	</a>
	<?endif;?>
